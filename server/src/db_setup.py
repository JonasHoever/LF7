...
class Init():
    ...
    def create_tables(self):
        self.cursor.execute("CREATE TABLE IF NOT EXISTS users (id int auto_increment primary key NOT NULL, nfc_tag bigint unique NOT NULL, pin int DEFAULT NULL, name varchar(255), surname varchar(255), active tinyint default 1);")

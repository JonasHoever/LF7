...
class Init():
    ...
    def create_tables(self):
        ...
        self.cursor.execute("CREATE TABLE IF NOT EXISTS user_data(session_id INT AUTO_INCREMENT PRIMARY KEY, user_id INT, checkin_time DATETIME, checkout_time DATETIME, date DATE DEFAULT CURRENT_DATE, status tinyint DEFAULT 1, session_duration DATETIME, FOREIGN KEY (user_id) REFERENCES users(id))")
    def del_tables(self):
